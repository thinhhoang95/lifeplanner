...
<div class="main_page">
    ...
    <table>
        ...
        foreach ($result as $item) {
            echo "<tr>";
            echo "<td class='abypass'>" . $item->id . "</td><td><a href='edit_workload.php?id=" .$item->id. "'>" . $item->work_name . "</a></td><td class='bypass'>" . $item->work_description . "</td><td>" . $item->remaining_units . "</td><td>" . $item->remaining_units_in_week . "</td>";
            echo "</tr>";
        }
        ?>
