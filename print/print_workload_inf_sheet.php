    ...
    <script>
        ...
        function print(o) {
            if (jspmWSStatus()) {
                ...
                cmds += formatWithMarginDoubleWidth('WORKLOAD INFORMATION SHEET');
                cmds += esc + '!' + '\x00'; //Character font A selected (ESC ! 0)
                cmds += newLine + newLine;
                ...
                cmds += newLine;
                cmds += formatWithMargin('SOCIAL CREDIT NUMBER: ******478               RECORD PAGE: 1');
                cmds += newLine;
                cmds += formatWithMargin('DATE ISSUED: ' + new Date());
             ...
             // cmds += formatWithMargin('1     Manifold Opt    Manifold theory review');
                ...
                foreach ($listOfPlans as $item) {
                    $i++;
           echo "cmds += formatWithMargin(padding('$i',6) + padding('$item->work_name',16) + wordwrap('$item->mission',38,22));"; 
           echo "cmds += newLine;";
                }
                ?>
                ...
                cmds += formatWithMargin('SHEET CODE: ' + makeid(12));
                cmds += newLine;
